...
import "../tasks/FastqProcessing_v6.0.0.wdl" as FastqProcessing
import "../tasks/StarAlign_v6.0.0.wdl" as StarAlign
import "../tasks/Metrics_v6.0.0.wdl" as Metrics
import "../tasks/RunEmptyDrops.wdl" as RunEmptyDrops
import "../tasks/CheckInputs_v6.0.0.wdl" as OptimusInputChecks
import "../tasks/MergeSortBam.wdl" as Merge
import "../tasks/H5adUtils_v6.0.0.wdl" as H5adUtils
